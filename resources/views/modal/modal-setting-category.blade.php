<div class="modal fade" id="modal-setting-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id='list'>
            ...
            <table id="listProductCategory" class="table table-bordered table-hover display mx-10 w-100">
                <thead>
        ...
        <div id="form-input" class="d-none">
            ...
            {{ Form::text('input-name', 'Name', '', ['placeholder'=>'input']) }}
        </div>
      </div>
